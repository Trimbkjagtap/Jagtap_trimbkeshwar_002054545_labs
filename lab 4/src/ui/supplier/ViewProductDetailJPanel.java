...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        saveFeatures();
        for(Feature f: Feature.getAllInstances()){
            if(f.getName() == null) {
                Feature.getAllInstances().remove(f);
                break;
            }
        }
    ...
    private void saveFeatures() {
       ...
       for(int i = 0; i < model.getRowCount(); i++){
            ...
            for(Feature f: Feature.getAllInstances()){
                if(f.getName() != null && f.getName().equals(tblFeatures.getValueAt(i, 0).toString())) {
                    product.getFeatures().set(i, f);
                    currentFeature = f;
                    break;
                }
            }
            currentFeature.setName(tblFeatures.getValueAt(i, 0).toString());
            currentFeature.setValue(product, tblFeatures.getValueAt(i, 1));
        }
    ...
    private void btnRemoveFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveFeatureActionPerformed
        ...
        Feature f = product.getFeatures().get(selectedRow);
        product.getFeatures().remove(selectedRow);
        f.removeHashKey(product);
    ...
    public void refreshTable() {
        ...
        for (Feature f : product.getFeatures()) {
            ...
            row[0] = f;
            row[1] = f.getValue(product) == null ? "Type value here" : f.getValue(product).toString();
            model.addRow(row);
        }
